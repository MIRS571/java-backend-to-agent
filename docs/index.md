...
当前已完成[第 1 章：Agent、LLM API、消息、上下文与模型局限](chapter01/agent-and-llm-api.md)、[第 2 章：Python、uv、异步与 FastAPI](chapter02/python-uv-async-fastapi.md)、[第 3 章：LangChain 基础](chapter03/langchain-basics.md)、[第 4 章：Structured Output 与 Tool Calling](chapter04/structured-output-and-tools.md)、[第 5 章：RAG 基础](chapter05/rag-basics.md)、[第 6 章：企业级 RAG 与 Qdrant](chapter06/enterprise-rag-with-qdrant.md)、[第 7 章：LangGraph 基础](chapter07/langgraph-basics.md)和[第 8 章：持久化、Runtime 与人工审批](chapter08/persistence-runtime-interrupts.md)，下一步为第 9 章 FastAPI 服务化与 Java 流式转发。
