...
当前已完成[第 1 章：Agent、LLM API、消息、上下文与模型局限](chapter01/agent-and-llm-api.md)、[第 2 章：Python、uv、异步与 FastAPI](chapter02/python-uv-async-fastapi.md)、[第 3 章：LangChain 基础](chapter03/langchain-basics.md)、[第 4 章：Structured Output 与 Tool Calling](chapter04/structured-output-and-tools.md)和[第 5 章：RAG 基础](chapter05/rag-basics.md)，下一步为第 6 章企业级 RAG。
